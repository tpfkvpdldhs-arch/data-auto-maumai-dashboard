...
3. 작업자 PC는 매일 19:00에 자동으로 업로드만 수행합니다.
...
```cron
CRON_TZ=Asia/Seoul
0 19 * * * flock -n /tmp/data_uploader.lock /opt/data-ops/run_daily_upload.sh --env-file /home/worv/data_uploader.env >> /home/worv/data_uploader.log 2>&1
```
...
1. 매일 19:10까지 활성 작업자 데이터가 Supabase에 들어옴
