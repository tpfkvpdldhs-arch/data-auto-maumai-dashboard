...
from collect_and_upload import parse_recording_csv  # noqa: E402
...
class ParseRecordingCsvTests(unittest.TestCase):
    ...
    def test_parse_valid_and_rejected_rows(self) -> None:
        csv_path = self.write_csv(
            """
            source_folder,folder_sort_key,filename,start_time,end_time,duration_sec,duration_mmss,map_segment
            bag,0,a.recording.log,2026-02-23 14:04:04.437,2026-02-23 14:11:00.715,416.278,06:56,r_road_west256_1
